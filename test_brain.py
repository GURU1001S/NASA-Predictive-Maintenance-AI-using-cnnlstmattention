...
# Fit scaler strictly on train regime, apply strictly to test regime
for r in range(6):
...
# Ensure you are loading the NEW weights after retraining base.py
...
# Research standard: Clip actuals to 125 to evaluate degradation accuracy
...
# Save a high-res copy to your folder for your resume/GitHub
